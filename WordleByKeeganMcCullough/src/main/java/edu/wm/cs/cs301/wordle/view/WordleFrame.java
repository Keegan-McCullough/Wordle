...
public class WordleFrame {
	...
	private JMenuBar createMenuBar() {
		...
		// adding the difficulty menu bar item
		JMenu difficultyMenu = new JMenu("Difficulty");
		menuBar.add(difficultyMenu);

		// Normal difficulty
		JMenuItem normalItem = new JMenuItem("Normal");
		normalItem.addActionListener(event -> switchDifficulty("Normal"));
		difficultyMenu.add(normalItem);

		// Pro difficulty
		JMenuItem proItem = new JMenuItem("Pro");
		proItem.addActionListener(event -> switchDifficulty("Pro"));
	...
	public void switchDifficulty(String difficulty){
		frame.dispose();
		new WordleFrame(new WordleModel(difficulty, model.getStatistics()));
	}
